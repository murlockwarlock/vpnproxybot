...
def main():
    ...
    print("\n[5/5] Installing deps if needed & restarting service...")
    ...
    run_cmd(ssh, f"systemctl restart {SERVICE}")
    run_cmd(ssh, f"sleep 3 && systemctl is-active {SERVICE}")

    print("\n=== Last 10 lines of log ===")
    run_cmd(ssh, f"journalctl -u {SERVICE} -n 10 --no-pager 2>&1")
